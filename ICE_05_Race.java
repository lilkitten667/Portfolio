...
public class ICE_05_Race extends Object
{
   public static void main(String[] args)
   {
        ...
        /* karel should pick up the baton, then move to the intersection that bob is in.
		  ...
		  // karel's robot movement
		  
		  karel.pickThing();
		  karel.move();
		  
		  // Karel finding her team mate 
		  while (karel.getStreet() != bob.getStreet())
		  {
		      karel.turnLeft();
		      karel.move();
		      karel.turnLeft();
		  ...
		  // Bob's leg of the race.
		  bob.pickThing();
		  
		  while (bob.getStreet() != mary.getStreet())
          {
              bob.turnLeft();
              bob.turnLeft();
              bob.turnLeft();
		  ...
		  // Bob blindingly searching for his partner
		  ...
		  // Mary gets to "bring it on home" as sponge bob says!
		  // and she is off....
		  mary.pickThing();
          ...
          mary.move();
          mary.putThing();
          while (mary.getDirection() != Direction.EAST)
          {
              mary.turnLeft();
          }
