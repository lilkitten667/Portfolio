...
class SageRobot extends Robot
{
    SageRobot(City c, int st, int ave, Direction dir, int num)
    {
    ...
    class Ex_04_1_Errors extends Object
    {
        public void main(String[] args)
        {
            City bothell = new City();
            SageRobot ian = new SageRobot(bothell, 2, 0, Direction.EAST, 0);
            ...
            while (ian.frontIsClear())
            {
                ...
                /*
                 * Send robot to the store, and get thing ian.move(); ian.pickThingSafer();
                 * ian.move(); ian.pickThingSafer(); ian.move(); ian.pickThingSafer();
                 */
                ...
                while (ian.countThingsInBackpack() < 0)
                {
                    if (true)
                    {
                        ian.putThing();
