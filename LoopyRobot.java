...
public class LoopyRobot extends Robot {
	...
	public int putRandomNumThings() {
		...
		int numThingsToPut = randomGenerator.nextInt(20);
		...
		while (counter < numThingsToPut) {
			...
			while (this.countThingsInBackpack() < numThingsToPut)
			{
			    putThing();
			    move();
			    return NUM_THINGS_TO_PUT_ON_STREET1 + 1;
			}
		}
		return counter;
	}
...
//		
	...
	public int putAtLeast1Thing() {
		...
		do {
			...
			{
			    putThing();
			    System.out.println("You have put down : " + counter + " things.");
			    move();
			    return counter;
			}
